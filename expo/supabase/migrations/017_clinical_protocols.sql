...
'[{"name":"Para 1 + Para 2","role":"Month 1 for adults with Biotoxin Binder","level":3},{"name":"Para 3 + Para 4","role":"Month 2 for adults with Biotoxin Binder","level":3},{"name":"Biotoxin Binder","role":"Concurrent with kill phase","level":3},{"name":"NDF Happy","role":"First choice for pediatric parasite support","level":3},{"name":"Microbe Slayer","role":"Pediatric antimicrobial alternative","level":3},{"name":"NAC 900","role":"If tolerated during kill phase","level":2},{"name":"Transdermal Glutathione","role":"Detox support during kill phase","level":2}]'::jsonb,
